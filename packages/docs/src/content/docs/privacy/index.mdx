...
[basalt.dev/privacy](https://basalt.dev/privacy). This page goes deeper.
...
| Pro (cockpit) | TLS to `api.basalt.dev` (Cloudflare Workers) |
| Vault Sync | Encrypted blobs to `r2-sync.basalt.dev` |
